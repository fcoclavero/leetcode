...
For example, a string such as "substitution" could be abbreviated as (but not limited
to):
...
Given a string word and an abbreviation abbr, return whether the string matches the
given abbreviation.
